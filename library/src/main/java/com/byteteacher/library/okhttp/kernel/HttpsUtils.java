...
public class HttpsUtils {
    ...
    /**
     * https双向认证
     * certificates -> 用含有服务端公钥的证书校验服务端证书 （ server.cer/server.crt ）
...
//            LogUtil.d(TAG, "checkClientTrusted() returned: ");
//        }
//
//        @Override
//        public void checkServerTrusted(X509Certificate[] chain, String authType) {
//            LogUtil.d(TAG, "checkServerTrusted() returned: ");
//        }
//
//        @Override
